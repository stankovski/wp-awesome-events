 ...
 * class now lives in the awesome-events plugin, to preserve backward
 * compatibility with existing post content, REST consumers, and ICS feeds.
 */

if (!defined('ABSPATH')) { exit; }

class Awesome_Events_Event_Meta {
    ...
    public function add_meta_box() {
        add_meta_box(
            'icob_event_meta',
            __('Event Date & Recurrence', 'awesome-events'),
        ...
        add_meta_box(
            ...
            __('Event Shortcodes', 'awesome-events'),
    ...
    $result['location'] = $location;
        ...
        if ($rec_type === 'weekly') {
            ...
            if ($weekdays) {
                ...
                $day_names = [
                    0 => __('Monday', 'awesome-events'),
                    1 => __('Tuesday', 'awesome-events'),
                    2 => __('Wednesday', 'awesome-events'),
                    3 => __('Thursday', 'awesome-events'),
                    4 => __('Friday', 'awesome-events'),
                    5 => __('Saturday', 'awesome-events'),
                    6 => __('Sunday', 'awesome-events'),
                ];
                $labels = [];
