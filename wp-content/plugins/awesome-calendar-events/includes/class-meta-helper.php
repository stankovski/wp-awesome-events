...
if (!function_exists('awecal_meta_key')) {
    /**
...
if (!function_exists('awecal_get_post_meta')) {
    /**
...
if (!function_exists('awecal_event_date_enabled_meta_query')) {
    /**
...
if (!function_exists('awecal_event_date_present_meta_query')) {
    /**
